#!/usr/bin/env python3
"""Apply the Stage 4.7 Hotfix 5e1 correction to a Hotfix 5e project."""
...
manifest = patch_root / "STAGE_4_7_HOTFIX_5E1_PATCH_FILE_MANIFEST.txt"
...
print(f"Applied Stage 4.7 Hotfix 5e1 ({len(files)} files) to {target}")
