#!/usr/bin/env python3
"""Apply Stage 4.7 Hotfix 2 to an extracted Stage 4.7 Hotfix 1 project."""
...
MANIFEST = "STAGE_4_7_HOTFIX_2_PATCH_FILE_MANIFEST.txt"


def main() -> int:
    if len(sys.argv) != 2:
        print("Usage: apply_stage_4_7_hotfix_2_patch.py <path-to-existing-seethe-project>")
        return 2
    ...
    for raw in manifest_path.read_text(encoding="utf-8").splitlines():
        ...
        copied += 1
    print(
        f"Stage 4.7 Hotfix 2 applied successfully: "
