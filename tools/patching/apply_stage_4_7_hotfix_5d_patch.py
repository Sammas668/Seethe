#!/usr/bin/env python3
"""Apply the Stage 4.7 Hotfix 5d patch tree to a Hotfix 5c project."""
...
manifest = patch_root / "STAGE_4_7_HOTFIX_5D_PATCH_FILE_MANIFEST.txt"
...
print(f"Applied Stage 4.7 Hotfix 5d ({len(files)} files) to {target}")
