#!/usr/bin/env python3
"""Apply the Stage 4.7 Hotfix 5e patch tree to a Hotfix 5d project."""
...
manifest = patch_root / "STAGE_4_7_HOTFIX_5E_PATCH_FILE_MANIFEST.txt"
...
print(f"Applied Stage 4.7 Hotfix 5e ({len(files)} files) to {target}")
