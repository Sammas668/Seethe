#!/usr/bin/env python3
"""Apply Stage 4.7 Hotfix 4 to an extracted Stage 4.7 Hotfix 3 project."""
from pathlib import Path
import shutil
import sys

MANIFEST = "STAGE_4_7_HOTFIX_4_PATCH_FILE_MANIFEST.txt"


def main() -> int:
    if len(sys.argv) != 2:
        print("Usage: apply_stage_4_7_hotfix_4_patch.py <path-to-existing-seethe-project>")
        return 2
    ...
    print("Stage 4.7 Hotfix 4 applied successfully.")
    return 0
