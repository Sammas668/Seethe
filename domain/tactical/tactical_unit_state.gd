...
var restraint_applied_by_unit_id: StringName = &""
...
func life_state_snapshot() -> Dictionary:
	return {
		...
		"restraint_applied_by_unit_id": restraint_applied_by_unit_id,
...
func restore_life_state(snapshot: Dictionary) -> void:
	...
	restraint_applied_by_unit_id = StringName(snapshot.get(
		"restraint_applied_by_unit_id", restraint_applied_by_unit_id
	))
...
func apply_restraint(
	...
	restraint_applied_by_unit_id = applied_by_unit_id
	_sync_combat_state_from_life()
	return true
