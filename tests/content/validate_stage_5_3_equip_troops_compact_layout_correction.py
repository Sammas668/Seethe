#!/usr/bin/env python3
"""Static acceptance checks for the Stage 5.3 Equip Troops Compact Layout Correction Update."""
...
if errors:
    print("Stage 5.3 Equip Troops Compact Layout Correction validation FAILED")
    for error in errors:
        print(" -", error)
    raise SystemExit(1)
