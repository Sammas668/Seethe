...
const DISMANTLING_RECIPES = [
	preload("res://content/dismantling/grain_crate.tres"),
	...
	preload("res://content/dismantling/storehouse_table.tres"),
	preload("res://content/dismantling/mace.tres"),
	preload("res://content/dismantling/training_spear.tres"),
	preload("res://content/dismantling/sanctuary_capture_spear.tres"),
]
...
const CHARACTER_TEMPLATES = [
	...
	preload("res://content/characters/reaver/barbarian_henchman.tres"),
...
static func create_catalogue() -> ContentCatalogue:
	...
	catalogue.register_troop_career(ReaverCareerContent.career_definition())
	catalogue.register_henchman_recruitment_definition(ReaverCareerContent.recruitment_definition())
	for stage: TroopPrestigeStageDefinition in ReaverCareerContent.prestige_stages():
		catalogue.register_prestige_stage(stage)
